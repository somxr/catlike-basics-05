...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.maxVelocityChange = EditorGUILayout.Slider(new GUIContent("Max Velocity Change", "Determines how snappy the movement is. Higher values result in more immediate speed changes."), fpc.maxVelocityChange, 1f, 1000f);
        GUI.enabled = true;
        ...
        fpc.sprintSpeed = EditorGUILayout.Slider(new GUIContent("Sprint Speed", "Determines how fast the player will move while sprinting."), fpc.sprintSpeed, fpc.walkSpeed, 500f);
